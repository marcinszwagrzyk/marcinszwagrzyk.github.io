...
# Pobranie wartości SHAP
shap_values_array = shap_values.values  # Kształt: (n_samples, n_features)

# Konwersja do DataFrame
shap_df = pd.DataFrame(shap_values_array, columns=[f"{col}_SHAP" for col in X_test.columns])